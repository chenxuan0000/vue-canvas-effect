...
var _neon = __webpack_require__(43);
...
var canvas = (0, _extends3.default)({}, components);
...
var install = function install(Vue) {
    ...
    (0, _keys2.default)(canvas).forEach(function (key) {
...
var _neon = __webpack_require__(44);
...
exports.default = {
  ...
  computed: {
    opts: function opts() {
      return (0, _assign2.default)({}, this.defaultOptions, this.options);
    }
  },
  components: {},
  methods: {},
  mounted: function mounted() {
    ...
    var loop = function loop() {
      _this2.requestAniId = window.requestAnimationFrame(loop);
      ++tick;
